...
<html>
<head>
<link rel="stylesheet" type="text/css" href="housecard.css"> 
...
<header>
	<div class="overlay">
<h1>Simply Find Your Dream House</h1>
  ...
  <div class="card">
    ...
    <div class="contentBx">
      ...
      <div class="size" style="height: 25px;">
        <h3><%=resultSet.getString("landsize")%></h3>
        
          </div>
      <div class="size" style="height: 25px;">
        <h3><%=resultSet.getString("bedrooms")%></h3>
        
          </div>
      <div class="size" style="height: 25px;">
        <h3><%=resultSet.getString("bathrooms")%></h3>
